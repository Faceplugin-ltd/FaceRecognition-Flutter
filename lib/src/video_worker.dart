...
/// A recognition match carried by a tracked VideoWorker face.
...
/// A single tracked face inside a VideoWorker `tracking` event.
...
/// Base type for parsed VideoWorker events.
...
/// Parse one VideoWorker event JSON string into a typed [VideoWorkerEvent].
...
/// Convert a tracked worker face into a [FaceBox] for overlays / gates.
...
/// Preview FILL_CENTER mapping (Android FaceView) from frame → view coords.
...
/// Merge eye-closeness labels/scores from a probe-detected list [pb] onto the
/// tracked list [track]. Swap left/right for mirrored front preview.
