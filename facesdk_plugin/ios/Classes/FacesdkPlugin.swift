...
public class FacesdkPlugin: NSObject, FlutterPlugin {
  ...
  public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
    ...
    case "setActivation":
      ...
      print("args: ", license)
        let ret = FaceSDK.setActivation(license)
      result(ret)
    case "init":
        let ret = FaceSDK.initSDK()
      result(ret)
    case "setParam":
      result(0)
    case "extractFaces":
      ...
      param.estimate_age_gender = true // Ensure this variable exists in your iOS code

    // Pass the parameter to faceDetection
